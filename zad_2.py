...
employee = Employee('Adam', 'Adam', '2002-01-10', '2002-01-10', 'Godula', 'Godulska', '40-400', '51515151')
employee1 = Employee('Wojtek', 'Wojtek', '2022-02-10', '1997-01-10', 'Warszawa', 'Katowicka', '40-401', '51515151')
employeeRoma = Employee('Mario', 'Buffon', '1992-11-11', '1990-01-10', 'Rome', 'Legions', '40-400', '51515151')
...
order1 = Order(employeeRoma, student1, [book1, book2, book3, book4], order_date='2000-01-10')
print(order1)
